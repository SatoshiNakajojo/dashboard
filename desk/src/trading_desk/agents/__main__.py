...
from .llm import DEFAULT_MODEL, AnthropicLLM, LLMClient, ScriptedLLM
...
def main() -> int:
    ...
    if not args.dry_run and not (os.environ.get("ANTHROPIC_API_KEY")
        ...
        print("\n  Aucune clé Anthropic trouvée.\n"
              "  Poser ANTHROPIC_API_KEY dans l'environnement, ou lancer\n"
              "  `ant auth login`. Pour vérifier le câblage sans clé et sans\n"
              "  dépense : --dry-run\n", file=sys.stderr)
        return 2
