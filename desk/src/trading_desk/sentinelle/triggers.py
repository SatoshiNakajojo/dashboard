...
# --------------------------------------------------------------------------
#  La regle du deblocage : definie AILLEURS, reexportee ici
# --------------------------------------------------------------------------
#
# Elle vit dans `trading_desk.deblocages`, qui n'importe rien. La raison est
# dans ce fichier-la : quatre lecteurs la partagent et trois n'ont pas besoin
# de pydantic, que ce module tire via `Bar`.
#
# La reexportation garde intacts tous les appelants existants — et surtout
# elle garde UNE SEULE definition. Une copie derive un jour, et la derive ne
# se voit pas dans les chiffres.
from ..deblocages import (  # noqa: F401
    DEBLOCAGE_AVANCE_J,
    DEBLOCAGE_DUREE_J,
    DEBLOCAGE_PART_MAX,
    DEBLOCAGE_PART_MIN,
