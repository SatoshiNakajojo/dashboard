      ...
      setLive(prev2=>{
        ...
        try{
          if(prev2 && prev2.crypto && prev2.stocks){
            ...
            const gsF=(_gp3.gdbSfondsUSD||0);
            const pC=_mC>0 ? (gcF*_ue3)/_mC - 1 : 0;
            const pS=_mS>0 ? (gsF*_ue3)/_mS - 1 : 0;
            const navC=_shC>0 ? (gcF/_shC)*_ue3 : _gp3.gdbC;   // cours €/part (money-weighted, base 10€)
            const navS=_shS>0 ? (gsF/_shS)*_ue3 : _gp3.gdbS;
            saveBase('cgi_fund_stats',{
              ...
              usdEur:_ue3,
              cgic:{nav:navC,valueEUR:Math.round(gcF*_ue3),pnlPct:pC*100},
              cgis:{nav:navS,valueEUR:Math.round(gsF*_ue3),pnlPct:pS*100},
              ts:Date.now()
            });
          }
        }catch(e){}
