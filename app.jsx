          ...
          try{
            ...
            try{
              if(kvBank && kvBank.savedAt){
                ...
                // #86e — mémoriser le breakdown cloud + savedAt pour une réconciliation APRÈS que
                // `live` soit construit (effet dédié plus bas). Robuste quelle que soit la branche de boot.
                try{ if(kvBank.breakdown) setCloudBankSync({ breakdown:kvBank.breakdown, savedAt:kvBank.savedAt, totalEUR:kvBank.totalEUR }); }catch(e){}
