  ...
  useEffect(()=>{
    ...
    (async()=>{
      try{
        ...
        // #90 — LOCAL SEUL. Le cloud cgi_bank n'est écrit QUE par les éditions explicites
        // (__cgiSetMatelas ← éditeur tactile & Dépôt/Retrait). L'observateur ne fait plus que
        // mettre à jour le local, pour ne JAMAIS pouvoir écraser une édition d'un autre appareil.
        const _bkSA=(function(){ try{ const b=lsv9Get('cgi_bank'); return (b&&b.savedAt)||0; }catch(e){ return 0; } })();
        try{ lsv9Set('cgi_bank', {...live.bank, breakdown:{...bd}, totalEUR:total, ...(_bkSA?{savedAt:_bkSA}:{})}); }catch(e){}
        console.info("[bank] solde local mis à jour (local seul, pas de push) ("+sig+")");
      }catch(e){}
    })();
  }, [live]);
  useEffect(()=>{
