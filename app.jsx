...
function PageAllocation({hidden, EFF, eur=false, setEur, iconDbVersion=0, bumpIconDb, liveOk=false, onTrade}){
  ...
  return(
    ...
    <div>
      ...
      {/* #63 — bouton transaction déplacé de la bannière vers le Portfolio, sous Live/Target */}
      {onTrade && (
        <button onClick={onTrade} title="Achat / Vente" style={{width:"100%",display:"flex",alignItems:"center",justifyContent:"center",gap:9,padding:"11px 0",marginBottom:16,borderRadius:10,border:`1px solid ${C.gold}`,background:(C.gold||"#C9A86A")+"18",color:C.gold,fontWeight:600,fontSize:13,cursor:"pointer",fontFamily:"inherit"}}>
          <Icon name="repeat" size={16}/> Achat / Vente
        </button>
      )}
