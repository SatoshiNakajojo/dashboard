...
function App(){
  ...
  const applyPositionsFromTxns=useCallback(()=>{
    ...
    if(base.portfolio && base.portfolio.items && base.portfolio.items.length>0){
      ...
      const DIP_USD=(_dipIt&&_dipIt.val!=null)?_dipIt.val:0; // solde IBKR USD — synchronisé par #67 (Cash Report), plus de valeur codée en dur
    ...
    const DIP_USD_FB=(_dipIt2&&_dipIt2.val!=null)?_dipIt2.val:0; var _hUSD=false,_hEUR=false;
