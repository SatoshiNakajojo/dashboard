  ...
  React.useEffect(()=>{
    try{
      ...
      saveBase('cgi_fund_stats',{..._cur,
        cgic:{nav:gcNAV*_ue, valueEUR:Math.round(gcFonds*_ue), pnlPct:gcPerfAllTime*100, sh:_ncgic.sh, mEUR:_ncgic.m},
        cgis:{nav:gsNAV*_ue, valueEUR:Math.round(gsFonds*_ue), pnlPct:gsPerfAllTime*100, sh:_ncgis.sh, mEUR:_ncgis.m},
        tsFunds:Date.now()});
