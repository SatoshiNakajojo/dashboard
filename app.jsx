...
{chartData,hidden,EFF,eur,liveGSB,liveGDBS,liveBench,liveGC,liveDD,liveInv}){
  ...
  // IMPÉRATIF cohérence — la sparkline ET le P&L de la carte dérivent de LA MÊME série, bâtie
  // EXCLUSIVEMENT sur le tableau de vérité mensuel (mêmes valeurs que fundPeriodPerf) + point live.
  // (On n'utilise plus _GDBS quotidien ici : c'est une source distincte qui divergeait du tableau.)
