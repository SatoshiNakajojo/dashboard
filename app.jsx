...
const APP_LOGO = "data:image/png;base64,";
      ...
      {(()=>{
        ...
        return(
          <div style={{marginBottom:20}}>
            <div style={{fontSize:10,letterSpacing:4,color:C.text2,textTransform:"uppercase",textAlign:"center",margin:"4px 0 12px"}}>Total portefeuille</div>
          ...
          {(()=>{
            ...
            return(
              <div style={{marginBottom:18}}>
                <div style={{fontSize:10,letterSpacing:4,color:C.text2,textTransform:"uppercase",textAlign:"center",margin:"4px 0 14px"}}>Répartition</div>
    ...
    <div key={themeName} style={{fontFamily:C.font||"'-apple-system',sans-serif",background:C.bg,minHeight:"100vh",color:C.text,maxWidth:430,margin:"0 auto",paddingBottom:78,boxShadow:themeName==="midnight"?"0 0 80px rgba(180,100,240,.08)":themeName==="bitcoin"?"0 0 80px rgba(247,147,26,.06)":"none"}}>
      <div style={{
        ...
        <div onClick={()=>setTab(0)} title="Accueil" style={{display:"flex",alignItems:"center",gap:11,cursor:"pointer",minWidth:0}}>
          <img src={APP_LOGO} alt="J.C." style={{width:42,height:38,objectFit:"contain",flexShrink:0,filter:"drop-shadow(0 2px 6px rgba(0,0,0,.5))"}}/>
      ...
      <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:430,background:C.bg,borderTop:`1px solid ${C.border}`,display:"flex",padding:"8px 0 20px",zIndex:100}}>
        {TABS.map((lb,i)=>(
          ...
          <button key={i} onClick={()=>setTab(i)} style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:4,height:52,padding:"4px 2px",background:"none",border:"none",cursor:"pointer",color:tab===i?C.gold:C.text3,transition:"color .15s"}}>
            {i===3
              ? <img src={APP_LOGO} alt="JCGI" style={{width:27,height:22,objectFit:"contain",opacity:tab===i?1:.5,transition:"opacity .15s"}}/>
          ...
          <div onClick={e=>e.stopPropagation()} style={{background:C.bg1,borderRadius:"20px 20px 0 0",padding:"20px 20px 36px",width:"100%",maxWidth:430,maxHeight:"85vh",overflowY:"auto",border:`1px solid ${C.border}`}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:10}}>
              {[
                ...
                ["v6.29","Nouveau blason J.C. GLOBAL INVESTMENTS partout (chargement, bandeau, onglet JCGI, icônes PWA) ; sous-titres centrés."],
                ["v6.27","Boot : la dernière valeur réelle est mémorisée et réaffichée à l'ouverture (cache d'état)."],
                ["v6.24","Worker : benchmarks S&P/Nasdaq/MSCI (/build_bench) + notifications Telegram quotidiennes (cron)."],
                ["v6.20","Stats : recherche par fourchette de dates → graphe sur mesure du patrimoine."],
