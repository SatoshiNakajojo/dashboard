  ...
  const handleRefresh = useCallback(async()=>{
    ...
    try{
      ...
      setLive(prev2=>{
        ...
        // #fund-pl — handleRefresh n'écrit QUE le total/crypto/actions (fusion ; les P&L fonds sont écrits par l'onglet JCGI)
        try{
          if(prev2 && prev2.crypto && prev2.stocks){
            const _m61 = computePortfolioModel(prev2);   // #61 — même modèle que le hero
            const _cur = lsv9Get('cgi_fund_stats')||{};
            saveBase('cgi_fund_stats',{..._cur,
              totalUSD:_m61.totalUSD,
              totalEUR:_m61.totalEUR,
              cryptoUSD:_m61.cryptoUSD,
              stocksUSD:_m61.stocksUSD,
              cashUSD:_m61.cashUSD,
              usdEur:_m61.usdEur, ts:Date.now()});
          }
        }catch(e){}
        return prev2;
      });
