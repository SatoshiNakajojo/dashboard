...
async function main() {
  ...
  console.log(
    [
      ...
      '  • Un SMTP à vous est indispensable : sans lui, Supabase garde les',
      '    gabarits en lecture seule et envoie le sien, qui contient un lien.',
      '    Authentication → Emails → Set up SMTP',
      '  • Puis le modèle « Magic Link » doit contenir {{ .Token }}, sinon le',
      '    courriel envoie un lien au lieu du code attendu par l’app.',
