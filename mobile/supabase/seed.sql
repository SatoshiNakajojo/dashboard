...
insert into public.profiles (id, display_name, initials, color) values
  ('11111111-1111-4111-8111-000000000001', 'John',  'JD', '#E8903D'),
...
-- Des votes argumentés (20260928090000_argued_votes). Le $WIF a cinq jours :
-- sa fenêtre de vote est close, et le garde refuserait ces lignes d'archive.
-- On le suspend le temps de les poser — ce fichier ne sert qu'en local.
alter table public.ticker_votes disable trigger ticker_votes_guard;

insert into public.ticker_votes (ticker_id, user_id, side, reason) values
  ('44444444-4444-4444-8444-000000000001', '11111111-1111-4111-8111-000000000001', 'bull', 'Le seul actif que je ne vends jamais non plus.'),
  ('44444444-4444-4444-8444-000000000001', '11111111-1111-4111-8111-000000000002', 'bull', 'Les ETF absorbent plus que ce que les mineurs produisent.'),
  ('44444444-4444-4444-8444-000000000001', '11111111-1111-4111-8111-000000000003', 'bull', 'Halving passé, offre qui se raréfie.'),
  ('44444444-4444-4444-8444-000000000001', '11111111-1111-4111-8111-000000000004', 'bull', 'DCA sans levier : difficile d’avoir tort sur dix ans.'),
  ('44444444-4444-4444-8444-000000000001', '11111111-1111-4111-8111-000000000005', 'bull', 'Les trésoreries d’entreprise commencent à peine.'),
  ('44444444-4444-4444-8444-000000000001', '11111111-1111-4111-8111-000000000007', 'bull', 'Cold storage, discipline : rien à redire.'),
  ('44444444-4444-4444-8444-000000000005', '11111111-1111-4111-8111-000000000001', 'bear', 'Un mème sans utilité, la liquidité partira ailleurs.'),
  ('44444444-4444-4444-8444-000000000005', '11111111-1111-4111-8111-000000000002', 'bear', 'Le prochain chien fera oublier celui-ci.'),
  ('44444444-4444-4444-8444-000000000005', '11111111-1111-4111-8111-000000000004', 'bear', 'Aucune thèse, c’est écrit dessus.'),
  ('44444444-4444-4444-8444-000000000005', '11111111-1111-4111-8111-000000000005', 'bear', 'Les baleines ont déjà vendu.'),
  ('44444444-4444-4444-8444-000000000005', '11111111-1111-4111-8111-000000000006', 'bear', 'Trop tard pour entrer, trop tôt pour rire.'),
  ('44444444-4444-4444-8444-000000000005', '11111111-1111-4111-8111-000000000007', 'bear', 'Je préfère perdre mon temps que mon argent.')
on conflict do nothing;

alter table public.ticker_votes enable trigger ticker_votes_guard;
